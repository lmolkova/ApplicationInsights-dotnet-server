namespace Microsoft.ApplicationInsights.DependencyCollector
{
    ...
    public class DependencyCollectorDiagnosticListenerTests
    {
        ...
        public void OnRequestWithRequestEvent()
        {
            ...
            Assert.AreEqual(InstrumentationKeyHashLookupHelper.GetInstrumentationKeyHash(instrumentationKey), GetRequestHeaderValues(request, RequestResponseHeaders.SourceInstrumentationKeyHeader).SingleOrDefault());
        ...
        public void OnResponseWithSuccessfulResponseEventWithMatchingRequestAndSameTargetInstrumentationKeyHashHeader()
        {
            ...
            response.Headers.Add(RequestResponseHeaders.TargetInstrumentationKeyHeader, targetInstrumentationKeyHash);
